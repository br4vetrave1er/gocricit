...
def customize_agent(agent_key, instructions=None, temperature=0.66, top_p=0.71, tools=None):
    """
...
# Response Generation
def generate_response(agent_key, message_body, wa_id, name):
    """
...
def deek_update(agent_key, user_thread, user_phonenumber):
    """
...
def generate_care_response(agent_key, user_thread, user_phonenumber):
    """
    ...
    try:
        ...
        deek_update(agent_key, user_thread, user_phonenumber)
